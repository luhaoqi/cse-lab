...
class ThrPool {
 public:
  ...
  bool addObjJob(C *o, void (C::*m)(A0, A1), A0 a0, A1 a1);
  template <class C, class A0, class A1, class A2>
  bool addObjJob(C *o, void (C::*m)(A0, A1, A2), A0 a0, A1 a1, A2 a2);
  template <class C, class A0, class A1, class A2, class A3>
  bool addObjJob(C *o, void (C::*m)(A0, A1, A2, A3), A0 a0, A1 a1, A2 a2,
                 A3 a3);
...
template <class C, class A0, class A1>
bool ThrPool::addObjJob(C *o, void (C::*m)(A0, A1), A0 a0, A1 a1) {
  class objfunc_wrapper {
   public:
    C *o;
...
template <class C, class A0, class A1, class A2>
bool ThrPool::addObjJob(C *o, void (C::*m)(A0, A1, A2), A0 a0, A1 a1, A2 a2) {
  class objfunc_wrapper {
   public:
    C *o;
...
template <class C, class A0, class A1, class A2, class A3>
bool ThrPool::addObjJob(C *o, void (C::*m)(A0, A1, A2, A3), A0 a0, A1 a1, A2 a2,
                        A3 a3) {
  class objfunc_wrapper {
   public:
    C *o;
